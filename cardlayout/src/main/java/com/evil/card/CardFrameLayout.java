 ...
 * @desc ...
 */
public class CardFrameLayout extends FrameLayout implements ICardLayout {
    ...
    public CardFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr)
    {
        super(context, attrs, defStyleAttr);
        HELPER = new CardLayoutHelper(new ICardView() {
            @Override
            public View getCurrentView() {
                return CardFrameLayout.this;
            }

            @SuppressLint("WrongCall")
            @Override
            public void superOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                CardFrameLayout.super.onMeasure(widthMeasureSpec, heightMeasureSpec);
            }
