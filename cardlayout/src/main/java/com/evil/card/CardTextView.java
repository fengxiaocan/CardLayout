 ...
 * @desc ...
 */
public class CardTextView extends TextView implements ICardLayout {
    private final CardLayoutHelper HELPER;

    public CardTextView(@NonNull Context context) {
    ...
    public CardTextView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr)
    {
        super(context, attrs, defStyleAttr);
        HELPER = new CardLayoutHelper(new ICardView() {
            @Override
            public View getCurrentView() {
                return CardTextView.this;
            }

            @SuppressLint("WrongCall")
            @Override
            public void superOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                CardTextView.super.onMeasure(widthMeasureSpec, heightMeasureSpec);
            }
