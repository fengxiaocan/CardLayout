 ...
 * @desc ...
 */
public class CardEditText extends EditText implements ICardLayout {
    private final CardLayoutHelper HELPER;

    public CardEditText(@NonNull Context context) {
    ...
    public CardEditText(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr)
    {
        ...
        HELPER = new CardLayoutHelper(new ICardView() {
            ...
            public View getCurrentView() {
                return CardEditText.this;
            }

            @SuppressLint("WrongCall")
            @Override
            public void superOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                CardEditText.super.onMeasure(widthMeasureSpec, heightMeasureSpec);
            }
