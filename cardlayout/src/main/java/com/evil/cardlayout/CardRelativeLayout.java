			...
			@NonNull Context context,@Nullable AttributeSet attrs,int defStyleAttr)
	{
		...
		this.mCardViewDelegate = new CardViewDelegate() {
			...
			public void setMinWidthHeightInternal(int width,int height) {
				if (width > CardRelativeLayout.this.mUserSetMinWidth) {
					CardRelativeLayout.super.setMinimumWidth(width);
				}
				
				if (height > CardRelativeLayout.this.mUserSetMinHeight) {
			...
			public void setCardBackground(Drawable drawable) {
				...
				CardRelativeLayout.this.setBackgroundDrawable(drawable);
			}
